...
class FirstOrderLocalAnalyzer(AbstractLocalInfluence):
    def load_and_setup(self, model_path, train_dataset):
        ...
        calculator = FirstOrderInfluenceCalculator(influence_model, train_dataset, ihvp_calculator=ihvp_calculator)
        
        return calculator, model

if __name__ == "__main__":
    analyzer = FirstOrderLocalAnalyzer(k_display=5)
    analyzer.run()